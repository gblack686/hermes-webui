...
const MAIN_VIEW_PANELS = ['home','overview','repos','lineage','documents','supabase','langfuse','kanbandata','settings','skills','memory','tasks','kanban','workspaces','profiles','insights','logs','plugin','pluginhub'];
